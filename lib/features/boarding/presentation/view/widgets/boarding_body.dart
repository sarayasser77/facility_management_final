...
class _BoardingBodyState extends State<BoardingBody> {
  ...
  Widget build(BuildContext context) {
    return currentIndex!=2? Container(
    ...
    child: Padding(
      ...
      child: Text("Skip",style: TextStyle(color: LIGHT_GREY,fontSize: 15),),
    ),
    ),
    ),
    Expanded(
    ...
    Padding(
      padding:  EdgeInsets.fromLTRB(8,8,8,MediaQuery.of(context).size.height/12,),
      child: Row(
        ...
        children: [
          ...
          InkWell(
            ...
            child:  CircleAvatar(radius: MediaQuery.of(context).size.width/14,backgroundColor: kPrimaryColor,child: Icon(Icons.arrow_forward_ios,color: Colors.white,),),
          )
        ],
      ),
    ),
